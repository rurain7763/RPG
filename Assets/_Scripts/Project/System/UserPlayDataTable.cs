...
public class UserPlayDataTable : UserDataTable
{
    ...
    public PlayLevelSystem PlayLevelSys { get; set; }
    ...
    public override void Update()
    {
        try
        {
            ...
            UpdatePlayLevelSystem(playData);
    ...
    private void UpdatePlayLevelSystem(UserPlayDataDTO dto)
    {
        PlayLevelSys = new PlayLevelSystem(dto.PlayLevelData);
    }
    ...
    {
        Progress = new ProgressSystem(dto.ProgressData);
    }
    ...
    public override void Upload()
    {
        try
        {
            ...
            UploadPlayLevelSystem(ref playData);
    ...
    private void UploadPlayLevelSystem(ref UserPlayDataDTO dto)
    {
        dto.PlayLevelData = PlayLevelSys.CaptureDTO();
    }
    ...
    {
        dto.ProgressData = Progress.CaptureDTO();
    }
